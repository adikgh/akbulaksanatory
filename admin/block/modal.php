		...
		<div class="pop_bl_cl">
			<div class="form_c">
				...
				<div class="form_im">
					...
					<div class="form_im_img user_img_add <?=($user['logo']?'form_im_img2':'')?>" <?=($user['logo']?'style="background-image: url(/assets/uploads/users/'.$user['logo'].')"':'')?> data-txt="Фотоны жаңарту">Құрылғыдан таңдау</div>
				</div>
		...
		<div class="pop_bl_cl">
			<div class="form_c">
				...
				<div class="form_im form_im_bn">
					<div class="btn btn_company_edit">
